		...
		return (
             ...
             */}
							...
							<p>
								...
								But the Berkus Method doesn’t stop with just qualitative
								drivers — you must assign a monetary value to each. In
								particular, up to $500K. $500K is the maximum value that can be
								earned in each category, giving the opportunity for a pre-money
								valuation of up to $2M-$2.5M. Berkus sets the hurdle number at
								$20M (in the fifth year in business) to “provide some
								opportunity for the investment to achieve a ten-times increase
								in value over its life.”
								<h6>
									find out more @{" "}
							...
							<br />
							<h2>
								What's your projected Revenue in 5 Years ? (Thousands USD)
							</h2>
							<Field
								type="revenue"
								name="revenue"
							...
							{!values.revenue ? (
								<h4
									...
									{" "}
									Enter your projected Revenue First:{" "}
								</h4>
							) : null}
							<Field
								type="valuation"
